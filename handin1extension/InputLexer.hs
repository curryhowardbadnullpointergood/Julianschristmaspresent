...
alex_table = listArray (0 :: Int, 2988)
  [ 0
  , 56
  , 56
  , 56
...
alex_check = listArray (0 :: Int, 2988)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 = \p s -> Tok p TokenComma
alex_action_1 = \p s -> Tok p TokenColon
alex_action_2 = \p s -> Tok p TokenSemiColon
alex_action_4 = \p s -> Tok p TokenID
alex_action_5 = \p s -> Tok p TokenStartID
alex_action_6 = \p s -> Tok p (TokenFieldType TTypeString)
alex_action_7 = \p s -> Tok p (TokenFieldType TTypeInteger)
alex_action_8 = \p s -> Tok p (TokenFieldType TTypeBoolean)
alex_action_9 = \p s -> Tok p TokenLabel
alex_action_10 = \p s -> Tok p TokenEndID
alex_action_11 = \p s -> Tok p TokenType
alex_action_12 = \p s -> Tok p (TokenStrVal (tail $ init s))
alex_action_13 = \p s -> Tok p (TokenIntVal (read s :: Int))
alex_action_14 = \p s -> Tok p (TokenBoolVal True)
alex_action_15 = \p s -> Tok p (TokenBoolVal False)
alex_action_16 = \p s -> Tok p TokenNullVal
alex_action_17 = \p s -> Tok p (TokenString s)
