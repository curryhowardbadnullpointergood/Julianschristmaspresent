...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_inputParser","File","NodeSets","NodeSet","NodeHeader","Fields","Field","NodeEntries","NodeEntry","Literals","Literal","Labels","Label","RelationshipSets","RelationshipSet","RelationshipHeader","RelationshipEntries","RelationshipEntry","\",\"","\":\"","\";\"","strVal","intVal","boolVal","nullVal","string","\":ID\"","type","\":LABEL\"","\":START_ID\"","\":END_ID\"","\":TYPE\"","%eof"]
...
happyReduction_1 (HappyAbsSyn16  happy_var_2)
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (File (reverse happy_var_1) (reverse happy_var_2)
	)
...
happyReduction_17 ((HappyAbsSyn14  happy_var_5) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn11
		 (NodeEntry happy_var_1 (reverse happy_var_3) (reverse happy_var_5)
	) `HappyStk` happyRest
...
happyReduction_18 (HappyAbsSyn12  happy_var_3)
	...
	(HappyTerminal (Tok _ (TokenString happy_var_1)))
	 =  HappyAbsSyn11
		 (NodeEntry happy_var_1 (reverse happy_var_3) []
	)
